...
export async function fetchFromFirestore2(
	setStoredItems: React.Dispatch<React.SetStateAction<MeatInfoAiO[]>>,
	setAgingItems: React.Dispatch<React.SetStateAction<MeatInfoAiO[]>>,
	place: string,
	thenWhat: () => void,
	catchWhat: () => void,
) {
...
export async function deleteFromAgingFridge(
	id: string,
	thenWhat?: Promise<void>,
) {
